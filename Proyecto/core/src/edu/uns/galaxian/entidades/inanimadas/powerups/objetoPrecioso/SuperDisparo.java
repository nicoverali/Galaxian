...
public class SuperDisparo extends PowerUp {
	...
	public SuperDisparo(Vector2 posicion, Vector2 velocidad, float rotacion, Controlador controlador) {
	...
	public void efectoJugador(Jugador jugador) {
		jugador.setArma(new ArmaDisparoDoble<DisparoJugador>(new FabricaEspecial(jugador)));
	}
