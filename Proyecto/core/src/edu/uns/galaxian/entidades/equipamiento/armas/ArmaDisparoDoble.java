...
public class ArmaDisparoDoble<T extends Disparo> extends ArmaTemporal<T> {
	...
	public ArmaDisparoDoble(FabricaDisparo<T> fabrica) {
		super(10); // Municion por defecto.
		this.fabrica = fabrica;
		this.ultimoDisparo = TimeUtils.millis() - CADENCIA;
	}
	
	public ArmaDisparoDoble(FabricaDisparo<T> fabrica, int maxMunicion) {
		super(maxMunicion);
		this.fabrica = fabrica;
		this.ultimoDisparo = TimeUtils.millis() - CADENCIA;
	}
