...
public class KamikazeMixto extends Enemigo{
	...
	public KamikazeMixto(Vector2 pos, int vida, float velocidadMax, int colisionDamage, Controlador controlador, GameObject estadoJugador) {
