...
public class KamikazeAleatorio extends Enemigo {

	private static final String TEXTURA_DIR = "./enemigos/kamikaze_aleatorio/estandar.png";
	...
	public KamikazeAleatorio(Vector2 pos, int vida, float velocidadMax, int colisionDamage, Controlador controlador, GameObject estadoJugador) {
