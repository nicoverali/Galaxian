...
import edu.uns.galaxian.juego.screen.util.NullSound;
...
public class Menu extends WidgetGroup {
    ...
    private EventListener menuListener;
    ...
    /**
     * Setea un nuevo sonido para reproducir cuando se cambia
     * el foco de las opciones del menu
     * @param focusSound Sonido de cambio de foco
     */
    public void setFocusSound(Sound focusSound){
    ...
    private void setOpcionEnFoco(int nuevaOpcionEnFoco){
        if(opcionActual != nuevaOpcionEnFoco){
            focusSound.play();
    ...
    public void removerListener(){
        this.removeListener(menuListener);
    }
